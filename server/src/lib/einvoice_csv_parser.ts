...
//
// Intentionally dependency-free (no Node/npm imports) so it runs identically in
// the backend and the parity test. Keep in lockstep with the Dart original — the
// parity test (einvoice_csv_parser.test.ts) guards this.
